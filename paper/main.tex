...
the student reproduces only part of the teacher's fidelity gain. We additionally articulate two
...
\begin{itemize}
  ...
  actors, hands, and thin objects. The full-flow RGB residual gains only 0.034 dB and the passing
  compact adapter gains 0.010 dB under the matched protocol; neither recovers the 7.24 dB gap to
  the fitted ceiling.
...
teacher's gain. The next visual model should therefore couple local birth sets and their geometry;
