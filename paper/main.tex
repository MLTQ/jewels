...
held-out clips at 23.2 dB / 0.942 SSIM / 0.469 LPIPS with macro-layout at the fitted ceiling
...
\centering
\small
\caption{One-shot encoding of the four held-out clips at native 288\(\times\)192 (step-3000
snapshot; training was still improving). The encoder is the first arm to beat the trivial
...
\textbf{Encoded one-shot (single forward pass)} & \textbf{23.24} & \textbf{0.9422} & \textbf{0.4693} & \textbf{29.98} \\
