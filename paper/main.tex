...
multi-seed error bars and additional points on the domain-matched LTX-fit axis (twelve training
clips now fitted under the same contract) are the immediate extension.
