...
rollout LPIPS from 0.6971 to 0.6760 --- the first macro parity with the guide-upsample baseline
--- while PSNR falls from 14.14 to 12.56, the third independent occurrence of the
blur-rewarding pattern. Every earlier realization number was paying an unmeasured cross-domain
tax, and every input to this arm's supervision is teacher-generated: prompt-matched videos,
fitted fields, and minutes of training, all priced in compute alone.
